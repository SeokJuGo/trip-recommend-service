...
<template>
  <div>
    <ul class="pagination justify-content-center">
      ...
      <li class="page-item">
        <a class="page-link" @click="$emit('onChangePageNum', pageNum == 1 ? 1 : pageNum - 1)">이전</a>
      </li>
      <!--
        <li class="page-item">
      ...
      -->
      <li class="page-item">
        <a class="page-link" @click="$emit('onChangePageNum', pageNum == totalPages ? totalPages : pageNum + 1)">다음</a>
      </li>
      <li class="page-item">
